  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE TABLE [dbo].[effects] (
        ...
        [data] NVARCHAR(MAX) NOT NULL,
        [target_statmod] NVARCHAR(50) NULL,
        [stat] NVARCHAR(50) NULL,
        [op] NVARCHAR(10) NULL,
        [value_num] FLOAT NULL,
        [value_expr] NVARCHAR(MAX) NULL,
        [target_damage] NVARCHAR(50) NULL,
        [damage_type] NVARCHAR(50) NULL,
        [amount_num] INT NULL,
        [amount_expr] NVARCHAR(MAX) NULL,
        [target_heal] NVARCHAR(50) NULL,
        [heal_num] INT NULL,
        [heal_expr] NVARCHAR(MAX) NULL,
